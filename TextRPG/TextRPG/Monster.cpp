...
Monster CreateMonster(const std::string name)
{
	...
	if (name == "트롤")
	{
		...
		monster.dropTable[0] = { { "트롤의 몽둥이", 50, 50, 0, 0, 10, 0.0f, 0.0f, ITEM_EQUIPWEAPON }, 20, 1, 1 };
		monster.dropTable[1] = { { "트롤 갑옷", 50, 50, 0, 0, 5, 0.0f, 0.0f, ITEM_EQUIPBODY } , 20, 1, 1 };
	...
	else if (name == "오크")
	{
		...
		monster.dropTable[0] = { { "오크의 도끼", 0, 0, 0, 0, 30, 0.2f, 0.3f, ITEM_EQUIPWEAPON }, 20, 1, 1 };
		monster.dropTable[1] = { { "오크 갑옷", 20, 20, 0, 0, 10, 0.0f, 0.0f, ITEM_EQUIPBODY }, 20 , 1, 1 };
	...
	else if (name == "고블린")
	{
		...
		monster.dropTable[0] = { { "고블린의 지팡이", 0, 0, 20, 20, 10, 0.1f, 0.1f, ITEM_EQUIPWEAPON }, 20, 1, 1 };
		monster.dropTable[1] = { { "고블린 로브", 0, 0, 30, 30, 10, 0.1f, 0.1f, ITEM_EQUIPBODY}, 20, 1, 1 };
